...
const material = (answer, evidence, confidence, aiProposal, independentChallenge, studentReasoning, effect, changedFromAI = false) => {
  const { effectBasis = 'correction', effectNote = '', closingBalance, ...statementEffect } = effect;
  return {
    answer, evidence, confidence, aiProposal, independentChallenge, studentReasoning,
    statementEffect, effectBasis, effectNote, ...(closingBalance ? { closingBalance } : {}), changedFromAI,
  };
};
...
const decisions = {
  ...
  D041: material('Classify €90,000 September deposits as contract liabilities, not August revenue.', [files.bank, files.contracts], 'high', 'Record the deposits as deferred revenue because delivery occurs in September.', 'The independent analysis reached the same conclusion from the signed delivery dates and bank receipts.', 'Cash arrived before performance. Recognition as revenue would overstate August profit by €90,000.', { effectBasis: 'original_transaction', effectNote: 'Cash received is an asset. The same €90,000 is a contract liability until performance.', profit: 0, cash: 90000, assets: 90000, liabilities: 90000, equity: 0 }),
  D042: material('Classify €50,000 new bank advance as borrowing.', [files.bank, files.loan], 'high', 'Record the €50,000 as new loan principal, not income.', 'The independent analysis confirmed that the signed bank agreement describes a repayable loan.', 'The legal form and repayment requirement are clear. Income classification would overstate profit by €50,000.', { effectBasis: 'original_transaction', effectNote: 'The bank receipt increases cash, which is part of total assets, and creates the matching loan liability.', profit: 0, cash: 50000, assets: 50000, liabilities: 50000, equity: 0 }),
  D043: material('Capitalise the €60,000 Pack-O-Matic 9000 as PPE.', [files.purchases, files.assets, files.bank], 'high', 'Capitalise the machine because it is available for use and provides a long-term operating resource.', 'The independent analysis agreed and treated the bank payment as investing cash flow.', 'The machine creates a long-term resource rather than restoring ordinary output.', { effectBasis: 'original_transaction', effectNote: 'Cash falls €60,000 and PPE rises €60,000, so total assets and equity do not change at purchase.', profit: 0, cash: -60000, assets: 0, liabilities: 0, equity: 0 }),
  D044: material('Capitalise the €20,000 Regret Photo Booth as PPE.', [files.purchases, files.assets, files.bank], 'high', 'Capitalise the photo booth and depreciate it within the period estimate.', 'The independent analysis agreed that the booth was available for use on 10 May.', 'The booth is equipment that remains available to support future events.', { effectBasis: 'original_transaction', effectNote: 'Cash falls €20,000 and PPE rises €20,000, so total assets and equity do not change at purchase.', profit: 0, cash: -20000, assets: 0, liabilities: 0, equity: 0 }),
  D045: material('Expense €10,000 belt replacement and calibration as repair.', [files.purchases, files.assets, files.bank], 'high', 'Expense the repair because it restored normal output without increasing capacity or useful life.', 'The independent analysis agreed with the supplier description of a restoration, not an improvement.', 'The evidence directly states that the work did not extend life or increase capacity.', { effectBasis: 'original_transaction', effectNote: 'The paid repair reduces cash and therefore total assets; the same expense reduces profit and equity.', profit: -10000, cash: -10000, assets: -10000, liabilities: 0, equity: -10000 }),
  D046: material('Classify the €70,000 villa reservation as owner distribution.', [files.bank, files.loan], 'high', 'Remove the villa from operating expense and record it as distribution to the owner.', 'The independent analysis agreed because the villa is personally owned and no customer meeting occurred.', 'There is no business purpose supported by evidence.', { effectBasis: 'original_transaction', effectNote: 'The owner withdrawal reduces cash, which is an asset, and reduces equity. It does not affect profit.', profit: 0, cash: -70000, assets: -70000, liabilities: 0, equity: -70000 }),
  D047: material('Classify €40,000 owner-card spending as owner distribution.', [files.bank, files.loan], 'high', 'Record the chairman card payment as a distribution, not payroll or marketing.', 'The independent analysis reached the same conclusion from the bank and owner-card evidence.', 'The payment lacks evidence of a genuine business purpose.', { effectBasis: 'original_transaction', effectNote: 'The owner withdrawal reduces cash, which is an asset, and reduces equity. It does not affect profit.', profit: 0, cash: -40000, assets: -40000, liabilities: 0, equity: -40000 }),
  D048: material('Classify €405,000 materials consumed on valid delivered sales as COGS.', [files.warehouse], 'medium', 'Use the independent physical-product consumption schedule as COGS.', 'The independent analysis agreed, while retaining the separate €9,000 stock uncertainty.', 'Consumption relates to fulfilled product sales rather than period-end inventory.', { effectBasis: 'original_transaction', effectNote: 'Consumption reduces inventory and total assets; the matching cost reduces profit and equity.', profit: -405000, cash: 0, assets: -405000, liabilities: 0, equity: -405000 }),
  D049: material('Classify €80,000 event-delivery staff as direct cost of events.', [files.payroll], 'medium', 'Include event delivery payroll in COGS because employees work directly on paid events.', 'The independent analysis agreed with the payroll file description.', 'The work is directly attributable to delivering the service sold to customers.', { effectBasis: 'correction', effectNote: 'This is a presentation reclassification within payroll expense: it moves €80,000 to direct event cost without changing total profit, cash, assets, liabilities or equity.', profit: 0, cash: 0, assets: 0, liabilities: 0, equity: 0 }),
  ...
  D056: material('Recognise €24,000 period depreciation.', [files.assets], 'medium', 'Use the independent depreciation estimate of €24,000.', 'The independent analysis agreed but flagged missing useful-life detail as an uncertainty.', 'The supplied asset schedule identifies €24,000 as the independent period estimate.', { effectBasis: 'correction', effectNote: 'Period-end adjusting entry: depreciation reduces net PPE, profit and equity but does not use cash.', profit: -24000, cash: 0, assets: -24000, liabilities: 0, equity: -24000 }),
  D057: material('Recognise €18,000 bad-debt write-off for R-17.', [files.contracts, files.later], 'high', 'Write off R-17 because no recovery is expected after liquidation.', 'The independent analysis agreed based on the liquidator notice.', 'The later notice confirms insolvency already present at the reporting date.', { effectBasis: 'correction', effectNote: 'Period-end correcting entry: the receivable, total assets, profit and equity fall; no cash is paid.', profit: -18000, cash: 0, assets: -18000, liabilities: 0, equity: -18000 }),
  D058: material('Recognise €22,000 write-down of damaged basement stock.', [files.warehouse, files.later], 'high', 'Reduce damaged inventory to nil recoverable value.', 'The independent analysis agreed that physical presence does not establish recoverability.', 'Both warehouse and independent assessment state that the stock is unsaleable.', { effectBasis: 'correction', effectNote: 'Period-end correcting entry: inventory, total assets, profit and equity fall; no cash moves.', profit: -22000, cash: 0, assets: -22000, liabilities: 0, equity: -22000 }),
  D059: material('Recognise €25,000 provision for former employee claim.', [files.loan, files.later], 'high', 'Recognise the external counsel best estimate as a provision.', 'The independent analysis agreed that the claim was probable at 31 August.', 'The obligation arose before reporting date and is both probable and reliably estimated.', { effectBasis: 'correction', effectNote: 'Period-end correcting entry: profit and equity fall while the provision liability rises; cash is not yet paid.', profit: -25000, cash: 0, assets: 0, liabilities: 25000, equity: -25000 }),
  ...
  D064: material('Recognise NorthStar revenue €180,000 on accepted delivery, 12 February.', [files.contracts, files.crm, files.bank], 'high', 'Recognise revenue on the accepted NorthStar delivery.', 'The independent analysis matched the contract, CRM and bank record despite customer-name variations.', 'Delivery and acceptance occurred before reporting date and cash was collected.', { effectBasis: 'original_transaction', effectNote: 'The collected cash is part of total assets, so total assets and equity rise together by €180,000.', profit: 180000, cash: 180000, assets: 180000, liabilities: 0, equity: 180000 }),
  D065: material('Recognise Freedom revenue €200,000 on accepted delivery, 18 March.', [files.contracts, files.crm, files.bank], 'high', 'Recognise the full invoice on accepted delivery; retain €58,000 receivable.', 'The independent analysis agreed with the signed acceptance and partial cash collection.', 'Recognition follows delivery, not cash collection.', { effectBasis: 'original_transaction', effectNote: 'Cash €142,000 plus receivable €58,000 equals the €200,000 increase in total assets and equity.', profit: 200000, cash: 142000, assets: 200000, liabilities: 0, equity: 200000 }),
  D066: material('Recognise Phoenix revenue €100,000 on completed event, 29 April.', [files.contracts, files.crm, files.bank], 'high', 'Recognise revenue when the Phoenix event was completed.', 'The independent analysis agreed; customer email acceptance supports completion.', 'The service was completed before reporting date despite partial cash collection.', { effectBasis: 'original_transaction', effectNote: 'Cash €70,000 plus receivable €30,000 equals the €100,000 increase in total assets and equity.', profit: 100000, cash: 70000, assets: 100000, liabilities: 0, equity: 100000 }),
  D067: material('Recognise Liberty revenue €120,000 on delivered order, 20 June.', [files.contracts, files.crm, files.bank], 'high', 'Recognise the full Liberty invoice on delivery and retain €25,000 receivable.', 'The independent analysis agreed with delivery evidence and customer acceptance.', 'Delivery and acceptance predate 31 August.', { effectBasis: 'original_transaction', effectNote: 'Cash €95,000 plus receivable €25,000 equals the €120,000 increase in total assets and equity.', profit: 120000, cash: 95000, assets: 120000, liabilities: 0, equity: 120000 }),
  D068: material('Do not recognise revenue for undelivered September events; retain €90,000 deposits as liabilities.', [files.contracts, files.bank, files.crm], 'high', 'Defer both September-event deposits until performance occurs.', 'The independent analysis independently reached the same conclusion from the September delivery dates.', 'Neither event had been delivered by 31 August.', { effectBasis: 'correction', effectNote: 'This correction reverses an incorrect revenue classification: cash and total assets do not change; liability rises €90,000 and equity/profit fall €90,000.', profit: -90000, cash: 0, assets: 0, liabilities: 90000, equity: -90000 }),
  ...
  D100: material('Do not use the management claim of €312,000 profit for earn-out; use corrected profit €65,000 only after board approval.', [files.management, files.bank, files.contracts, files.loan], 'high', 'Reject management profit €312,000 for earn-out and rely on corrected accounts.', 'The independent analysis agreed after reconciling cash, deposits, debt and omitted provisions.', 'The management figure includes September deposits and loan income and omits material corrections.', { effectBasis: 'correction', effectNote: 'The board decision creates no additional accounting movement; it prevents reliance on the misstated management measure.', profit: 0, cash: 0, assets: 0, liabilities: 0, equity: 0 }),
};
...
for (const decision of filledDecisions.filter((item) => item.reviewTier === 'material_judgment')) {
  const { statementEffect: effect, effectBasis, closingBalance } = decision;
  if (!['original_transaction', 'correction', 'closing_balance'].includes(effectBasis)) {
    throw new Error(`${decision.id} has an invalid effect basis.`);
  }
  if (effectBasis === 'closing_balance') {
    if (!closingBalance || Object.values(effect).some((value) => value !== 0)) {
      throw new Error(`${decision.id} closing balance must not be recorded as another movement.`);
    }
  } else if (effect.assets !== effect.liabilities + effect.equity) {
    throw new Error(`${decision.id} statement effect does not balance: assets must equal liabilities plus equity.`);
  }
}
